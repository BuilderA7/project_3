class MeditationsController < ApplicationController
  ...
  def index
    ...
    @students = ["James Obrey", "Marcus Talent", "Samuel Doe", "Amin Lenin", "Isaiah Luke", "Moses Ben"]
    if (current_instructor != nil || current_admin != nil )

        flash[:notice] = "Hello, you are in demo mode. Below you are able to assign a pass fail or other grade for each of your students. You can then click submit to submit their grades for this meditations period."
    end
  end
