...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { password: @instructor.password, user: @instructor.user } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { password: @instructor.password, user: @instructor.user } }
